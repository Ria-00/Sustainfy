...
class EncryptionService {
  ...
  String decryptData(String encryptedData) {
    ...
    print("4444444444444444444444444444${encryptedData}");
...
// void main(){
//     EncryptionService().init("TryBreaking7the!");
//     print(EncryptionService().encryptData('Paper123!'));
//     print(EncryptionService().decryptData('iv:encrypted'));
//   }