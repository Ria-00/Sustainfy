...
class _NgoCommunityPageState extends State<NgoCommunityPage> {
  ...
  void _getEvents() async {
    ...
    List<EventModel> fetchedEvents =
        await operate.getAllEventsExcludingNgo(ngoRef!);
    ...
    for (var event in fetchedEvents) {
      ...
      fetchedNgoNames[ngoReference.id] =
          ngoSnapshot["ngoName"] ?? "Unknown NGO";
    }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text("NGO: ${ngoNames[event.ngoRef!.id] ?? 'Loading...'}",
        ...
        ? ListView.builder(
            ...
            itemBuilder: (context, index) => GestureDetector(
              onTap: () => Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      NgoEventDescriptionPage(event: filteredEvents[index]),
                ),
              ),
